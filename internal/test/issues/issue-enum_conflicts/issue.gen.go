// Package enumconflicts provides primitives to interact with the openapi HTTP API.
//
...
const (
	...
	FoodGroupVegetable FoodGroup = "Vegetable"
)

// Defines values for Fruit.
const (
...
// Defines values for Town.
const (
	TownGoulburn Town = "Goulburn"
	TownOrange   Town = "Orange"
	TownParks    Town = "Parks"
)

// Defines values for Vegetable.
const (
...
// Town defines model for Town.
type Town string

// Vegetable defines model for Vegetable.
